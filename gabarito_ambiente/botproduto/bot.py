...
def acessar_site(bot):
    ...
    bot.print_pdf('C:\\Users\\noturno\\gabarito_ambiente\\botproduto\\pdf\\SiteProduto.pdf')
...
def main():
    ...
    arq_excel = 'C:\\Users\\noturno\\gabarito_ambiente\\botproduto\\planilha\\RelacaoProduto.xlsx'
    sheet = 'produto'  
    ...
    lista_pdf = []
    lista_pdf.append('C:\\Users\\noturno\\gabarito_ambiente\\botproduto\\pdf\\ListaProduto.pdf')
    lista_pdf.append('C:\\Users\\noturno\\gabarito_ambiente\\botproduto\\pdf\\SiteProduto.pdf')
